...
As my text editor / IDE / everything else (mostly), I use [Emacs](https://www.gnu.org/software/emacs/emacs.html) because I write in org-mode (I use a framework called [Doom Emacs](https://github.com/doomemacs/doomemacs)).
