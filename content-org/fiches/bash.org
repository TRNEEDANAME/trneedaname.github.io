...
#+begin_abstract Pour executer le code
...
La commande chmod est expliqué [[*chmod][ici]]
#+end_abstract
...
#+begin_tip La différence entre while et until
[[https://www.gnu.org/savannah-checkouts/gnu/bash/manual/bash.html#Looping-Constructs][Page info de Bash sur les boucles]]
