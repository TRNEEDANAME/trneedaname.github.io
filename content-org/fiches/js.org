...
#+HUGO_BASE_DIR: ../../
#+HUGO_LAYOUT: page
#+FILETAGS: fiches javascript français
#+DATE: 2025-10-10
...
{{{relref(Exercices,Exercices de Javascript)}}}
...
Le Javascript utilise le [[https://fr.wikipedia.org/wiki/Camel_case][Camel Case]] pour nommer les variables et fonctions, par exemple on écrira ~maVariable~, les opération on toujours un espace
